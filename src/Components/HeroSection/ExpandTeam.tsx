      ...
      <div className="w-full bg-[#000000] py-4 sm:py-6 md:py-8 lg:py-16 flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6 lg:gap-8 max-w-8xl px-4 sm:px-6">
          ...
          <div className="TextContent max-w-2xl items-center justify-center my-6 sm:my-8 md:my-12 lg:my-32 px-4 sm:px-6">
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-5xl font-bold text-gray-700 mb-3 sm:mb-4">
              Expand your <TextType
                ...
                cursorCharacter="|"
              /> <br />
              team Instantly with AiPRL’s AI Assistant
            </h3>
            <p className="text-gray-500 mt-2 sm:mt-3 text-sm sm:text-base md:text-lg lg:text-lg">
              AiPRL works like a full sales, service, and admin team in one powerful AI assistant, available 24/7. From qualifying leads to scheduling, FAQs, and request management, it takes care of the busy work so your team can focus on closing deals and driving growth.
            </p>
            <div className="ml-0 sm:ml-2 md:ml-4 lg:ml-10">
              <p className="text-gray-500 mt-3 sm:mt-4 md:mt-6 text-xs sm:text-sm md:text-base lg:text-lg">
                <CheckCheck className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-green-500 inline-block mr-2" />All-in-One Smart Inbox – Seamlessly unifies chat, SMS, email, and phone to cut response times from hours to minutes.
              </p>
              <p className="text-gray-600 mt-2 sm:mt-3 md:mt-4 text-xs sm:text-sm md:text-base lg:text-lg">
                <CheckCheck className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-green-500 inline-block mr-2" />Scalable & Reliable – Deliver consistent, high-quality customer experiences every time, while freeing your team to do more.
              </p>
              <button 
                onClick={handleButtonClick}
                className="px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3 lg:px-10 lg:py-3 mt-3 sm:mt-4 border border-gray-300 bg-transparent text-gray-500 dark:border-white dark:text-white relative group transition duration-200 hover:scale-105 active:scale-95 cursor-pointer text-xs sm:text-sm md:text-base lg:text-lg font-medium"
              >
