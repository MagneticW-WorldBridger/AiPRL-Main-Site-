...
export function SparklesPreview() {
  return (
    <>
      <div className="grid grid-cols-1 mt-8 sm:mt-24 md:mt-[3rem] lg:mt-[1.2rem]">
        <div className=" w-full col-span-2 flex flex-col items-center justify-center overflow-hidden">
          ...
          <h1 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold text-center text-black relative z-20 px-4 sm:px-6 md:px-8">
          ...
          <div className="w-full sm:w-[90%] md:w-[80%] lg:w-[85%] mt-4 sm:mt-8 md:mt-6 mb-3 relative px-4 sm:px-6 md:px-8">
            <p className="text-center px-0 sm:px-4 md:px-8 lg:px-16 xl:px-32 mt-4 sm:mt-6 text-xs sm:text-base md:text-lg lg:text-xl font-semibold text-black relative z-20">
          ...
          <div className="w-[90%] sm:w-[80%] md:w-[75%] lg:w-[60%] xl:w-[50%] 2xl:w-[40%] h-16 sm:h-20 md:h-22 lg:h-24 relative rounded-b-2xl">
            {/* Gradients */}
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-6 sm:mt-8 w-full sm:w-auto px-4 sm:px-6">
