    ...
    return (
        <>
            <div className="fixed top-2 right-2 sm:top-3 sm:right-3 md:top-4 md:right-4 z-40">
                <button
                    onClick={onOpen}
                    className="inline-flex items-center justify-center rounded-xl bg-black scale-125 sm:scale-140 md:scale-150 text-white cursor-pointer h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10"
